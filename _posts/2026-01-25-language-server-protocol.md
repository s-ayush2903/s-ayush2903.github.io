...
navigation: True
title: Understanding Language Server Protocol and Language Servers
...
This also changes the complexity of the initial problem to (m + n), because now every editor only needs to interact with the language server.
...
I found it interesting and implemented some very basic components for a toy language, to gain familiarity with the LSP and GoLang. You can give it a look too over here.

Further reading:

LSP: https://microsoft.github.io/language-server-protocol/

LSP impls: https://microsoft.github.io/language-server-protocol/implementors/servers/
